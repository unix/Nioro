...
local resize = {
  resize = {
    ...
    args = {
      ...
      resizePartyFrame = {
        name = L.SETTINGS_RESIZE_PARTY_FRAME,
        type = 'range',
        width = 'full',
        min = 0.5,
        max = 3,
        ...
        order = 7,
        set = function(info, value)
          Actions:setPartyFrameScale(value)
        end,
        get = function()
          return NIORO_DB.SETTINGS.PARTY_FRAME_SCALE or 1
        end
      },
      resizeSep3 = separatorGenerator(8),
      resizeFrame = {
        name = L.SETTINGS_RESIZE_RAID_FRAME,
        type = 'range',
        width = 'full',
        min = 0.5,
        max = 3,
        ...
        order = 9,
        set = function(info, value)
          Actions:setRaidFrameScale(value)
        end,
        get = function()
